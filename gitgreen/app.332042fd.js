...
},{"./cjs/react-dom.production.min.js":"jF7N"}],"kql1":[function(require,module,exports) {
...
},{"core-js/shim":"mRaX","regenerator-runtime/runtime":"KA2S","core-js/fn/regexp/escape":"p1zn"}],"Lat4":[function(require,module,exports) {
...
var App = function App(props) {
  ...
  var queryUser = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              setUser(user);
              _context.next = 3;
              return fetch("https://gitgreen.herokuapp.com/user/".concat(user));
            ...
            case 6:
              newfield = _context.sent.map(function (day) {
                day.added = 0;
                return day;
              });
              setCalendar(newfield);
              setOrigin("https://github.com/".concat(user, "/greens.git"));
    ...
    return function queryUser(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  var generateCommits = function generateCommits() {
    var top = 0;
    ...
    var commits = [];
    var unit = Math.floor(top * .25); // bad aprox.

    var _iterator2 = _createForOfIteratorHelper(calendar),
        _step2;
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (_day.added > 0) {
          var cnt = _day.added * unit;
          commits.push("echo ".concat(Math.random(), " > ").concat(_day.date, ".txt"));
          commits.push("git add ".concat(_day.date, ".txt"));

          while (cnt > 0) {
            commits.push("echo ".concat(Math.random(), " > ").concat(_day.date, ".txt"));
            commits.push("git commit -m '.' --date='".concat(_day.date, "_13-37-").concat(cnt, "' -a"));
            cnt--;
          }
        }
      }
    ...
    var commands = [['mkdir dir && cd dir'], ['git init']].concat(commits, [["git remote add origin ".concat(origin)], ["git push origin master"], [""]]);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    id: "clickInfo"
  }, "click - draw ", /*#__PURE__*/_react.default.createElement("br", null), "click + shift - delete"), /*#__PURE__*/_react.default.createElement(OriginInput, {
    origin: origin,
    setOrigin: setOrigin
  }), /*#__PURE__*/_react.default.createElement(TextareaCopy, {
    commands: origin ? generateCommits() : ''
  }));
};

var TextareaCopy = function TextareaCopy(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("button", {
    id: "copy",
    onClick: clipboard
  }, "copy to clipboard!"), /*#__PURE__*/_react.default.createElement("textarea", {
    readOnly: true,
    ref: textarea,
...
var OriginInput = function OriginInput(props) {
  ...
  })), "remote repository:", /*#__PURE__*/_react.default.createElement("input", {
    placeholder: "https://github.com/<user>/<repo>",
    value: origin,
    onChange: function onChange(e) {
      return setOrigin(e.target.value);
    }
  }));
};
...
var SearchBox = function SearchBox(props) {
  ...
  (0, _react.useEffect)(function () {
    if (user !== null) {
      var endOfTypingDelay = setTimeout(function () {
        props.queryUser(user);
      }, 500);
      return function () {
...
var Calendar = function Calendar(props) {
  var _useState9 = (0, _react.useState)('add'),
      _useState10 = _slicedToArray(_useState9, 2),
      tool = _useState10[0],
      setTool = _useState10[1];
  ...
  var drawBox = function drawBox(i) {
    if (!tool) return;
    if (!mousedown) return;
    var current = +props.calendar[i].level + props.calendar[i].added;
    if (tool == 'add' && current < 4) props.calendar[i].added += 1;
    if (tool == 'remove' && props.calendar[i].added > 0) props.calendar[i].added -= 1;
    props.setCalendar(_toConsumableArray(props.calendar));
  };

  var clickBox = function clickBox(i) {
    var current = +props.calendar[i].level + props.calendar[i].added;
  ...
  if (props.calendar == null) {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
      className: "git-grid ".concat((props === null || props === void 0 ? void 0 : props.user) !== null ? 'git-loading' : 'git-idle')
    }, Array(371).fill(null).map(function (day, i) {
      return /*#__PURE__*/_react.default.createElement("div", {
        key: i,
        className: "box"
      });
  ...
  }, props.calendar.map(function (day, i) {
    return /*#__PURE__*/_react.default.createElement("div", {
      key: day.date,
      ...
      className: "box l".concat(+day.level + day.added)
    });
  })));
};

_reactDom.default.render( /*#__PURE__*/_react.default.createElement(App, null), document.querySelector('#root'));
},{"react":"HdMw","react-dom":"X9zx","babel-polyfill":"JIy0","./style.css":"Lat4"}]},{},["vZyd"], null)
//# sourceMappingURL=app.332042fd.js.map